...
The Daz product scan now recognises **hand-installed content the old matchers could never see** (runtime v91), so far fewer used assets land in "unmatched". The gaps closed — each verified against a real library's scan diagnostics:
