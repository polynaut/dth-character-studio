  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "pointer-events-none block rounded-full shadow-[0_1px_2px_rgb(0_0_0/0.5),0_2px_4px_rgb(0_0_0/0.4)] ring-0 transition-transform group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-[linear-gradient(to_bottom,#d8dce2,#a8adb5)] data-[state=checked]:translate-x-[calc(100%-4px)] data-[state=checked]:bg-[linear-gradient(to_bottom,#ffffff,#e0e4ea)]"
        )}
      />
    </SwitchPrimitive.Root>
  )
