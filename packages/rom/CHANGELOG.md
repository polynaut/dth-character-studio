...
- [#631](https://github.com/polynaut/dth-character-studio/pull/631) [`03c72ed`](https://github.com/polynaut/dth-character-studio/commit/03c72ed9a196cddde78f6737a6302b29fe9fa701) Thanks [@polynaut](https://github.com/polynaut)! - fix: a missing DTH Exporter no longer fails silently, and the ROM save stops lying
...
- [#633](https://github.com/polynaut/dth-character-studio/pull/633) [`3c180ab`](https://github.com/polynaut/dth-character-studio/commit/3c180ab523b8bb8fd278f515aa57b384ccb6a633) Thanks [@polynaut](https://github.com/polynaut)! - fix: "ROM scene saved" now means it actually was
...
- [#594](https://github.com/polynaut/dth-character-studio/pull/594) [`ab51023`](https://github.com/polynaut/dth-character-studio/commit/ab5102332d27e80ae17b251c637d24dd0c217662) Thanks [@polynaut](https://github.com/polynaut)! - feat(rom): Houdini-ready export layout. Two changes to where and how the DTH export lands:
...
- [#573](https://github.com/polynaut/dth-character-studio/pull/573) [`3ee54fb`](https://github.com/polynaut/dth-character-studio/commit/3ee54fb1841200fa16f5893af807d23c6b40f46e) Thanks [@polynaut](https://github.com/polynaut)! - Every generated per-character Daz script (ROM, Export, Hair export, Product scan) now refuses to run when the open Daz scene isn't one of the character's linked scenes — an error dialog names the open scene and the linked ones (the ROM script also writes the run log), instead of silently applying everything to the wrong scene. Runtime v36: Tools → Refresh assets regenerates existing scripts with the guard.
