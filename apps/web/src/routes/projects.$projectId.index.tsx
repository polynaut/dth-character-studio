...
import { LANDSCAPE_LIFT, Portrait } from '#/components/portrait.tsx'
                  ...
                  >
                    ...
                    >
                      <Portrait
                        ...
                        name={character.name}
                        // The character's own framing nudge, in BOTH views.
                        ...
                        imgClassName={view === 'list' ? LANDSCAPE_LIFT : undefined}
                        className={cn(
                          'shrink-0 rounded-md',
