        ...
        <RemoveAssetDialog
          ...
          description={
            managedProject(pendingRemove)
              ? 'This project was generated by the studio. With "Keep houdini files" on it is only unlinked; turned off, the scene file is deleted from disk (the houdini folder itself stays — the other scenes of this character live there).'
