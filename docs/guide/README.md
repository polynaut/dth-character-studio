...
- **[Daz Studio](https://www.daz3d.com/daz-studio)** with a **Genesis 9** character (G9 is fully supported, G8 only partially)
...
- **[SideFX Houdini](https://www.sidefx.com/products/houdini/)** — needed for the far side of the pipeline (step 6)
